            ...
            <div class="auto-container clearfix">
                <div class="top-left">
                    ...
                    <ul class="info-list">
                        ...
                        <li><a href="mailto:foodbank2878@gmail.com" style="color: black"><span class="icon far fa-envelope"></span>
                                foodbank2878@gmail.com</a></li>
                    </ul>
                </div>
                    ...
                    <div class="option-list">
                        ...
                        <div class="cart-btn">
                            <a href="view_cart.php" class="icon flaticon-shopping-cart" style="color: black"><span
                                    class="total-cart" style="background-color: #a40301;color:white"><?php echo load_cart_data(); ?></span></a>
                        </div>
                        <!-- Search Btn -->
                ...
                <div class="auto-container clearfix">
                    ...
                    <div class="nav-outer clearfix">
                                ...
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="dropdown"><a href="#">User</a>
                                        <ul>
                                            ...
                                            if(isset($_SESSION["user_username"]))
                                            {
                                                ?><li><a href="edit_profile.php">Edit Profile</a></li> <?php
                                                ?><li><a href="change_password.php">Change Password</a></li> <?php
                                                ?><li><a href="view_my_order.php">view order</a></li> <?php
                        ...
                        <div class="outer-box">
                            <div class="order">
                                Order Now
                                <span><a href="tel:9737232032">9737232035</a></span>
                            </div>
                        </div>
