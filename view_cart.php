                                        ...
                                        <td class="prod-column">
                                            <div class="column-box">
                                                <figure class="prod-thumb"><a href="#"><img
                                                            src="../admin/<?php echo $img_session ?>" alt=""></a>
                                                </figure>
                                            </div>
                                        </td>
                                        <td>
                    ...
                    <div class="row clearfix" style="margin-top: 10px;">
                        ...
                        <div class="column pull-right col-lg-5 col-md-12 col-sm-12">
                            ...
                            <ul class="totals-table">
                                ...
                                <li class="clearfix total"><input type="radio" name="r1" value="cod" checked> <span
                                        class="col" style="text-align: left">Cash On Delivery</span></li>
                                <li class="clearfix total"><input type="radio" name="r1" value="paypal"><span
                                        class="col" style="text-align: left">PayPal</span></li>
                    ...
                    <div class="row clearfix" style="margin-top: 10px;">
                        ...
                        <div class="column pull-right col-lg-5 col-md-12 col-sm-12">
                            ...
                            <ul class="totals-table">
                                ...
                                <li class="text-right">
                                    <button type="submit"
                                            class="theme-btn btn-style-five proceed-btn" name="continue2"><span
