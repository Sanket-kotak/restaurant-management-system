                        ...
                        <div class="info-column col-lg-6 col-md-12 col-sm-12">
                            ...
                            <div class="inner-column">
                                ...
                                <div class="other-options clearfix">
                                    ...
                                    <button type="button" name="submit1" class="theme-btn btn-style-five" onclick="add_to_cart('<?php echo $id ?>',document.getElementById('qty').value);"><span class="txt">Add
                                                    to cart</span></button>
                                </div>
                            </div>
                            </form>
...
<section class="similar-products-section">
    <div class="auto-container">
        ...
        <div class="row clearfix">
            ...
            <?php
            $res=mysqli_query($link,"select * from food where food_category='$food_category' && id!=$id");
            while($row=mysqli_fetch_array($res))
            {
                ?>
